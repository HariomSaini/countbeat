...
`${GOPATH}/src/github.com/HariomSaini/countbeat`
...
```
git remote set-url origin https://github.com/HariomSaini/countbeat
...
```
mkdir -p ${GOPATH}/src/github.com/HariomSaini/countbeat
git clone https://github.com/HariomSaini/countbeat ${GOPATH}/src/github.com/HariomSaini/countbeat
```
